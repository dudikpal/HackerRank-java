...
public class BuildAStackExchangeScraper {
    ...
    public String check(String pattern){
        ...
        String testString = "<div class=\"question-summary\" id=\"question-summary-80407\">\n" +
        ...
        StringBuilder input = new StringBuilder(testString);
        StringBuilder result = new StringBuilder();
        String separator = "";
        int numberOfQuestions = testString.split("<h3><a href=\"/questions/").length - 1;
    ...
    private String createResultLine(StringBuilder input) {
